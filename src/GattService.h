...
struct GattService : GattInterface {
    ...
    // new characteristic is declared with a UUID and a variable argument list of flags (in string form.) For a complete
    // and up-to-date list of flag values, see:
    ...
    //
    GattCharacteristic &gattCharacteristicBegin(
    ...
    virtual const std::string getInterfaceType() const {
        return GattService::kInterfaceType;
    }
};
