...
// >>
//
// A GATT descriptor is the component within the Bluetooth LE standard that holds and serves metadata about a
// Characteristic over Bluetooth. This class is intended to be used within the server description. For an explanation of
// how this class is used, see the detailed discussion in Server.cpp.
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
bool GattDescriptor::callMethod(
    ...
    for (const DBusMethod &method : methods) {
        if (methodName == method.getName()) {
            method.call<
                GattDescriptor>(pConnection, getPath(), getName(), methodName, pParameters, pInvocation, pUserData);
            return true;
        }
    }
