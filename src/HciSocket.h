...
public:
    ...
    //
    // Raw data is read until no more data is available. If no data is available when this method initially starts to
    // read, it will retry for a maximum timeout defined by `kMaxRetryTimeMS`.
    //
