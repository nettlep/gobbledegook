...
Server::Server(
    ...
    objects
        ...
        .onReadValue(CHARACTERISTIC_METHOD_CALLBACK_LAMBDA { self.methodReturnValue(pInvocation, "Acme Inc.", true); })
        ...
        // Standard characteristic "ReadValue" method call
        .onReadValue(CHARACTERISTIC_METHOD_CALLBACK_LAMBDA { self.methodReturnValue(pInvocation, "Marvin-PA", true); })
        ...
        // from the idleFunc (see Init.cpp).
        ...
        // has been quite useful for testing to ensure we're connected and updating.
        ...
        //
        // This service will simply return the result of asctime() of the current local time. It's a nice test service
        // to provide a new value each time it is read.
        ...
        //
        // This is a cheezy little service that reads the CPU info from /proc/cpuinfo and returns the count and model of
        // the CPU. It may not work on all platforms, but it does provide yet another example of how to do things.
