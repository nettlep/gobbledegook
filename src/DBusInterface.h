...
#define TRY_GET_INTERFACE_OF_TYPE(pInterface, type)                                                                    \
    (pInterface->getInterfaceType() == type::kInterfaceType ? std::static_pointer_cast<type>(pInterface) : nullptr)

#define TRY_GET_CONST_INTERFACE_OF_TYPE(pInterface, type)                                                              \
    (pInterface->getInterfaceType() == type::kInterfaceType ? std::static_pointer_cast<const type>(pInterface)         \
                                                            : nullptr)
...
struct DBusInterface {
    ...
    virtual const std::string getInterfaceType() const {
        return DBusInterface::kInterfaceType;
    }
    ...
    DBusInterface &
    addMethod(const std::string &name, const char *pInArgs[], const char *pOutArgs, DBusMethod::Callback callback);
